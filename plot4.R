...
plot(y=data$Voltage,x=data$time_stamp,type='l',
     ylab='Voltage',xlab='datetime')

plot(y=data$Sub_metering_1,x=data$time_stamp,type='l',ylab='Energy sub metering',xlab='',col='black')
points(y=data$Sub_metering_2,x=data$time_stamp,type='l',ylab='Energy sub metering',xlab='',col='red')
points(y=data$Sub_metering_3,x=data$time_stamp,type='l',ylab='Energy sub metering',xlab='',col='blue')
legend(x='topright',legend=c('Sub_metering_1','Sub_metering_2','Sub_metering_3'),col=c('black','red','blue'),
       cex=.5,bty='n',lty=1)

plot(y=data$Global_reactive_power,x=data$time_stamp,type='l',
